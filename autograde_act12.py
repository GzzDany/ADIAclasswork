...
def load_producst():
  df = pd.read_csv("ADIAclasswork/olist_products_dataset.csv", index_col="Unnamed 0: ")
  return df

def load_reviews():
  df = pd.read_csv("ADIAclasswork/olist_order_reviews_dataset.csv", index_col="Unnamed 0: ")
  return df

def load_order_items():
  df = pd.read_csv("ADIAclasswork/olist_oder_items_dataset.csv", index_col="Unnamed 0: ")
  return df
